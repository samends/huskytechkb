  ...
  */
  ...
  <div class="wrapper">
	  ...
	  $main_url=$current_url.'/img/web.jpg'; ?>
    ...
    <div class="rowbottom topcategoryrow3 category-temp row-fluid">
		  <?php $software_query = new WP_Query( array( 'posts_per_page' => '10', 'category_name' => 'network', 'orderby' => 'date')); ?>
